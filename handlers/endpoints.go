...
const AUTH_API string = "https://auth.api.sonyentertainmentnetwork.com/2.0/"
...
const GAME_ENDPOINT string = "https://us-tpy.np.community.playstation.net/trophy/v1/trophyTitles"
